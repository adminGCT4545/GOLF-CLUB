...
const RevenueAnalytics: React.FC = () => {
  ...
  const [trendData] = useState([
    { month: 'Jan', membership: 70000, green_fees: 18000, fnb: 12000, pro_shop: 8500 },
    { month: 'Feb', membership: 71000, green_fees: 19500, fnb: 12800, pro_shop: 9200 },
    { month: 'Mar', membership: 72500, green_fees: 22000, fnb: 13500, pro_shop: 10800 },
    { month: 'Apr', membership: 73000, green_fees: 24000, fnb: 14200, pro_shop: 11500 },
    { month: 'May', membership: 75000, green_fees: 25750, fnb: 15000, pro_shop: 10000 },
  ]);
  ...
  const handleExport = async () => {
    try {
      const response = await erpAPI.exportReport('revenue-analytics', { 
        period, 
        stream: selectedStream 
      });
      downloadFile(response.data, `revenue_analytics_${period}_${new Date().toISOString().split('T')[0]}.xlsx`);
    } catch (err) {
