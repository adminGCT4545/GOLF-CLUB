...
const EmployeeDirectoryPage: React.FC = () => {
  const [employees, setEmployees] = useState<Employee[]>([
    ...
    },
    {
      ...
      firstName: 'David',
      lastName: 'Rodriguez',
      email: 'david.rodriguez@royalgolf.com',
      phone: '(555) 567-8901',
      position: 'Cart Attendant',
      department: 'Course Maintenance',
      hourlyRate: 18.50,
      status: 'Active',
    ...
    },
    {
      ...
      firstName: 'Emily',
      lastName: 'Thompson',
      email: 'emily.thompson@royalgolf.com',
      phone: '(555) 678-9012',
  ...
  const departments = ['All', 'Pro Shop', 'F&B', 'Golf Operations', 'Course Maintenance', 'Administration'];
  const positions = [
    'Pro Shop Manager',
    'Sales Associate',
    'Inventory Clerk',
  ...
  const getDepartmentStats = () => {
    const stats = departments.filter(dept => dept !== 'All').map(dept => ({
      department: dept,
      count: employees.filter(emp => emp.department === dept && emp.status === 'Active').length,
      avgRate: employees.filter(emp => emp.department === dept && emp.status === 'Active')
        .reduce((sum, emp, _, arr) => sum + emp.hourlyRate / arr.length, 0)
    }));
            ...
            <Card>
              <CardContent>
                ...
                <Typography variant="body2" color="text.secondary">
                  employees • avg ${stat.avgRate.toFixed(2)}/hr
                </Typography>
              </CardContent>
            </Card>
          </Grid>
